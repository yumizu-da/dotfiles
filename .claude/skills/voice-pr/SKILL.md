...
main や develop ブランチである場合は、必ずそこからブランチを切る
main や develop ブランチがない場合は、ユーザにブランチを切る必要があるかユーザーに確認して、必要であればどのブランチから切るかユーザーに選択してもらう
...
`.claude/commands/review-pr.md` の `review-pr` コマンドを呼び出して、変更内容を包括的にレビューする
